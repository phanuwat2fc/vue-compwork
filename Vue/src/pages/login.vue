<template>
  <div>
    <div class="container mx-auto bg-[#06283D] h-[36rem] mt-20">
      <div class="flex flex-col text-center m-14">
        <label class="text-3xl font-mono font-bold mt-16 text-white" for=""
          >LOGIN</label
        >
        <form class="mt-8 text-center" @submit="login">
          ...
          <div class="flex justify-between items-center mt-4 mb-4">
            ...
            <div>
              <a for="" href="" class="text-white underline font-bold"
                >Forgot Password?
              </a>
            </div>
          </div>
