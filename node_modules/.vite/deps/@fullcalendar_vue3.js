...
function w(n2, l3, u3, i3, t3, o2, r3, c3, s3, a3) {
  var h4, y3, d2, k3, b3, g4, w4, x4 = i3 && i3.__k || e, C3 = x4.length;
  for (u3.__k = [], h4 = 0; h4 < l3.length; h4++)
    if (null != (k3 = u3.__k[h4] = null == (k3 = l3[h4]) || "boolean" == typeof k3 ? null : "string" == typeof k3 || "number" == typeof k3 || "bigint" == typeof k3 ? v(null, k3, null, null, k3) : Array.isArray(k3) ? v(p, { children: k3 }, null, null, null) : k3.__b > 0 ? v(k3.type, k3.props, k3.key, k3.ref ? k3.ref : null, k3.__v) : k3)) {
      if (k3.__ = u3, k3.__b = u3.__b + 1, null === (d2 = x4[h4]) || d2 && k3.key == d2.key && k3.type === d2.type)
        x4[h4] = void 0;
      else
        for (y3 = 0; y3 < C3; y3++) {
...
function j(n2, u3, i3, t3, o2, r3, f3, e3, c3) {
  var a3, h4, v3, y3, _3, k3, b3, g4, m3, x4, A3, C3, $2, H3, I3, T4 = u3.type;
  ...
  try {
    n:
      if ("function" == typeof T4) {
        if (g4 = u3.props, m3 = (a3 = T4.contextType) && t3[a3.__c], x4 = a3 ? m3 ? m3.props.value : a3.__ : t3, i3.__c ? b3 = (h4 = u3.__c = i3.__c).__ = h4.__E : ("prototype" in T4 && T4.prototype.render ? u3.__c = h4 = new T4(g4, x4) : (u3.__c = h4 = new d(g4, x4), h4.constructor = T4, h4.render = O), m3 && m3.sub(h4), h4.props = g4, h4.state || (h4.state = {}), h4.context = x4, h4.__n = t3, v3 = h4.__d = true, h4.__h = [], h4._sb = []), null == h4.__s && (h4.__s = h4.state), null != T4.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = s({}, h4.__s)), s(h4.__s, T4.getDerivedStateFromProps(g4, h4.__s))), y3 = h4.props, _3 = h4.state, v3)
          ...
          if (null == T4.getDerivedStateFromProps && g4 !== y3 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(g4, x4), !h4.__e && null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(g4, h4.__s, x4) || u3.__v === i3.__v) {
            for (h4.props = g4, h4.state = h4.__s, u3.__v !== i3.__v && (h4.__d = false), h4.__v = u3, u3.__e = i3.__e, u3.__k = i3.__k, u3.__k.forEach(function(n3) {
              n3 && (n3.__ = u3);
        ...
        if (h4.context = x4, h4.props = g4, h4.__v = u3, h4.__P = n2, C3 = l.__r, $2 = 0, "prototype" in T4 && T4.prototype.render) {
          for (h4.state = h4.__s, h4.__d = false, C3 && C3(u3), a3 = h4.render(h4.props, h4.state, h4.context), H3 = 0; H3 < h4._sb.length; H3++)
            h4.__h.push(h4._sb[H3]);
          h4._sb = [];
        } else
          do {
            h4.__d = false, C3 && C3(u3), a3 = h4.render(h4.props, h4.state, h4.context), h4.state = h4.__s;
          } while (h4.__d && ++$2 < 25);
        h4.state = h4.__s, null != h4.getChildContext && (t3 = s(s({}, t3), h4.getChildContext())), v3 || null == h4.getSnapshotBeforeUpdate || (k3 = h4.getSnapshotBeforeUpdate(y3, _3)), I3 = null != a3 && a3.type === p && null == a3.key ? a3.props.children : a3, w(n2, Array.isArray(I3) ? I3 : [I3], u3, i3, t3, o2, r3, f3, e3, c3), h4.base = u3.__e, u3.__h = null, h4.__h.length && f3.push(h4), b3 && (h4.__E = h4.__ = null), h4.__e = false;
      } else
...
function L(l3, u3, i3, t3, o2, r3, e3, c3) {
  var s3, h4, v3, y3 = i3.props, p3 = u3.props, d2 = u3.type, k3 = 0;
  ...
  if (null === d2)
    ...
    if (r3 = r3 && n.call(l3.childNodes), h4 = (y3 = i3.props || f).dangerouslySetInnerHTML, v3 = p3.dangerouslySetInnerHTML, !c3) {
      if (null != r3)
        for (y3 = {}, k3 = 0; k3 < l3.attributes.length; k3++)
          y3[l3.attributes[k3].name] = l3.attributes[k3].value;
      (v3 || h4) && (v3 && (h4 && v3.__html == h4.__html || v3.__html === l3.innerHTML) || (l3.innerHTML = v3 && v3.__html || ""));
    }
...
function P(u3, i3, t3) {
  var o2, r3, e3;
  l.__ && l.__(u3, i3), r3 = (o2 = "function" == typeof t3) ? null : t3 && t3.__k || i3.__k, e3 = [], j(i3, u3 = (!o2 && t3 || i3).__k = h2(p, null, [u3]), r3 || f, f, void 0 !== i3.ownerSVGElement, !o2 && t3 ? [t3] : r3 ? null : i3.firstChild ? n.call(i3.childNodes) : null, e3, !o2 && t3 ? t3 : r3 ? r3.__e : i3.firstChild, o2), z(e3, u3);
}
function B(n2, l3) {
...
l.unmount = function(n2) {
  ...
  var i3 = e3.__a && h2(p, null, n2.fallback);
  return i3 && (i3.__h = null), [h2(p, null, e3.__a ? null : n2.children), i3];
};
...
function flushSync(runBeforeFlush) {
  ...
  P(h2(FakeComponent, {}), document.createElement("div"));
...
var ContentInjector = class extends BaseComponent {
  ...
  render() {
    ...
    if (customGenerator != null) {
      const customGeneratorRes = typeof customGenerator === "function" ? customGenerator(renderProps, h2) : customGenerator;
    ...
    return h2(props.elTag, attrs, innerContent);
  }
  componentDidMount() {
...
var ContentContainer = class extends d {
  ...
  render() {
    ...
    if (props.children) {
      ...
      if (props.elTag) {
        return h2(props.elTag, elAttrs, children);
      } else {
        return children;
      }
    } else {
      return h2(ContentInjector, Object.assign(Object.assign({}, props), { elTag: props.elTag || "div", elClasses: (props.elClasses || []).concat(generatedClassNames), renderId: this.context }));
    }
  }
  componentDidMount() {
    var _a, _b;
...
function InnerContentInjector(containerComponent, props) {
  ...
  return h2(ContentInjector, Object.assign({ renderProps: parentProps.renderProps, generatorName: parentProps.generatorName, customGenerator: parentProps.customGenerator, defaultGenerator: parentProps.defaultGenerator, renderId: containerComponent.context }, props));
}
...
var Scroller = class extends BaseComponent {
  ...
  render() {
    ...
    return h2("div", { ref: this.handleEl, className: className.join(" "), style: {
...
function renderChunkContent(sectionConfig, chunkConfig, arg, isHeader) {
  let { expandRows } = arg;
  let content = typeof chunkConfig.content === "function" ? chunkConfig.content(arg) : h2("table", {
    role: "presentation",
    className: [
  ...
  }, arg.tableColGroupNode, h2(isHeader ? "thead" : "tbody", {
    role: "presentation"
...
function renderMicroColGroup(cols, shrinkWidth) {
  ...
  for (let colProps of cols) {
    ...
    for (let i3 = 0; i3 < span; i3 += 1) {
      colNodes.push(h2("col", { style: {
        width: colProps.width === "shrink" ? sanitizeShrinkWidth(shrinkWidth) : colProps.width || "",
        minWidth: colProps.minWidth || ""
      } }));
    }
  }
  return h2("colgroup", {}, ...colNodes);
}
...
var SimpleScrollGrid = class extends BaseComponent {
  ...
  render() {
    ...
    }, Boolean(!isBuggy && headSectionNodes.length) && h2("thead", roleAttrs, ...headSectionNodes), Boolean(!isBuggy && bodySectionNodes.length) && h2("tbody", roleAttrs, ...bodySectionNodes), Boolean(!isBuggy && footSectionNodes.length) && h2("tfoot", roleAttrs, ...footSectionNodes), isBuggy && h2("tbody", roleAttrs, ...headSectionNodes, ...bodySectionNodes, ...footSectionNodes));
  }
  renderSection(sectionConfig, microColGroupNode, isHeader) {
    if ("outerContent" in sectionConfig) {
      return h2(p, { key: sectionConfig.key }, sectionConfig.outerContent);
    }
    return h2("tr", { key: sectionConfig.key, role: "presentation", className: getSectionClassNames(sectionConfig, this.props.liquid).join(" ") }, this.renderChunkTd(sectionConfig, microColGroupNode, sectionConfig.chunk, isHeader));
  }
  renderChunkTd(sectionConfig, microColGroupNode, chunkConfig, isHeader) {
    ...
    return h2(isHeader ? "th" : "td", {
      ref: chunkConfig.elRef,
      role: "presentation"
    }, h2(
      "div",
      { className: `fc-scroller-harness${isLiquid ? " fc-scroller-harness-liquid" : ""}` },
      h2(Scroller, { ref: this.scrollerRefs.createRef(sectionKey), elRef: this.scrollerElRefs.createRef(sectionKey), overflowY, overflowX: !props.liquid ? "visible" : "hidden", maxHeight: sectionConfig.maxHeight, liquid: isLiquid, liquidIsAbsolute: true }, content)
    ));
  }
...
var ToolbarSection = class extends BaseComponent {
  render() {
    ...
    return h2("div", { className: "fc-toolbar-chunk" }, ...children);
  }
  renderWidgetGroup(widgetGroup) {
    ...
    for (let widget of widgetGroup) {
      ...
      if (buttonName === "title") {
        isOnlyButtons = false;
        children.push(h2("h2", { className: "fc-toolbar-title", id: props.titleId }, props.title));
      } else {
        ...
        children.push(h2("button", { type: "button", title: typeof buttonHint === "function" ? buttonHint(props.navUnit) : buttonHint, disabled: isDisabled, "aria-pressed": isPressed, className: buttonClasses.join(" "), onClick: buttonClick }, buttonText || (buttonIcon ? h2("span", { className: buttonIcon }) : "")));
      }
    }
    if (children.length > 1) {
      let groupClassName = isOnlyButtons && theme.getClass("buttonGroup") || "";
      return h2("div", { className: groupClassName }, ...children);
    }
    return children[0];
  }
};
var Toolbar = class extends BaseComponent {
  ...
  renderSection(key, widgetGroups) {
    let { props } = this;
    return h2(ToolbarSection, { key, widgetGroups, title: props.title, navUnit: props.navUnit, activeButton: props.activeButton, isTodayEnabled: props.isTodayEnabled, isPrevEnabled: props.isPrevEnabled, isNextEnabled: props.isNextEnabled, titleId: props.titleId });
  }
};
var ViewHarness = class extends BaseComponent {
  ...
  render() {
    ...
    return h2("div", { "aria-labelledby": props.labeledById, ref: this.handleEl, className: classNames.join(" "), style: { height, paddingBottom } }, props.children);
  }
  componentDidMount() {
...
var CalendarContent = class extends PureComponent {
  ...
  render() {
    ...
    return h2(
      ...
      { value: viewContext },
      toolbarConfig.header && h2(Toolbar, Object.assign({ ref: this.headerRef, extraClassName: "fc-header-toolbar", model: toolbarConfig.header, titleId: viewLabelId }, toolbarProps)),
      h2(
        ViewHarness,
      ...
      toolbarConfig.footer && h2(Toolbar, Object.assign({ ref: this.footerRef, extraClassName: "fc-footer-toolbar", model: toolbarConfig.footer, titleId: "" }, toolbarProps))
    );
  }
  componentDidMount() {
    let { props } = this;
  ...
  renderView(props) {
    ...
    return h2(ViewComponent, Object.assign({}, viewProps));
  }
};
  ...
  constructor(el, optionOverrides = {}) {
    ...
    this.handleRenderRequest = () => {
      if (this.isRendering) {
        ...
        flushSync(() => {
          P(h2(CalendarRoot, { options: currentData.calendarOptions, theme: currentData.theme, emitter: currentData.emitter }, (classNames, height, isHeightAuto, forPrint) => {
            this.setClassNames(classNames);
            this.setHeight(height);
            return h2(
              RenderId.Provider,
              { value: this.customContentRenderId },
              h2(CalendarContent, Object.assign({ isHeightAuto, forPrint }, currentData))
            );
          }), this.el);
        });
